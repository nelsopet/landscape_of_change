...
We also wanted to look more specifically at a group of pollinating insects. To do so, we explored the bumblebees (*Bombus spp.*) to get a baseline of this important pollinator group. There were `r length(which(bombus.table$present.1900=='yes'))` species recorded by Proctor, and `r length(which(bombus.table$present.mod=='yes'))` species recorded today on MDI. However, the species turnover is where things get interesting. If you look at **Table 2** you can see the breakdown of when each species was present on MDI, and you'll notice that there are 4 species that Proctor identified and are no longer present on MDI. What is most notable about these species is that they are all cuckoo-bumble bees, a group of that invades other bumble bee colonies, kills the queen, and takes control of the workers. These species have been undergoing large-scale range reductions, and some of this can be attributed to their host species also decreasing. An example is the Ashton’s Cuckoo-Bumble Bee, and its host, the Rusty-patched Bumble Bee which is now federally endangered beacuse of its population loss (you can read more about this species in the next paragraph). Additionally, there are 3 species that we have documented today that were not collected by Proctor.

Threatened and endangered species were another category we wanted to explore the status of on MDI. Historically, Proctor collected specimens of a Maine endangered species known as the [Edwards' Hairstreak](https://www.maine.gov/ifw/docs/endangered/edwardshairstreak_106_107.pdf) (*Satyrium edwardsii*). According to the MDIFW Endangered Species Program, this species today has only been found at three sites in southwestern Maine. The extensive reduction in abundance of this species can largely be attributed to the loss of their native habitat, pitch pine-scrub oak barrens, which have been reduced to less than 50% of their historic range (MDIFW Endangered Species Program, 2003). A federally endangered species, the [Rusty-patched Bumble Bee](https://ecos.fws.gov/ecp/species/9383) (*Bombus affinis*) has experienced a similar fate as the Edwards' Hairstreak. This species was collected by Proctor in the early 1900's, and according to the U.S. Fish & Wildlife Service, was once widespread across most of the eastern United States. This species requires grasslands and prairies, a ecotype that has taken devastating losses due to degredation, fragmentation, and conversion to agriculture or development (U.S. Fish & Wildlife Service, 2021). Proctor once collected this species on MDI, but today the closest iNaturalist record of this species was in western New York in 1996.
...
**Table 2**. This table shows just the bumble bee species that the iNaturalist community and Proctor identified, and when they were present on MDI. Data collected on Mount Desert Island, Maine, USA, and provided by iNaturalist and the National Park Service.
